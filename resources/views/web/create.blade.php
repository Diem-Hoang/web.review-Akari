...
@section('content')
    <div class="createpost-content">
        ...
        @csrf
            ...
            <div class="row">
                <label class="name-input" for="theme">カテゴリ<span class="req">*</span></label>
            ...
            <div class="row">
                ...
                @endphp
                <label class="name-input" for="category">サブカテゴリ<span class="req">*</span></label>
            ...
            <div class="row">
            <input type="submit" class="button" value="追加"></div>
        </form>
    </div>
    @endsection
    <script>
